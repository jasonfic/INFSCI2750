...
public class LogAnalyze1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setMapperClass(LogAnalyze1.accessLogMap.class);
        job.setReducerClass(LogAnalyze1.accessLogReduce.class);
    ...
    public static class accessLogMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        private final static String URLtoMatch = "/assets/img/home-logo.png";
